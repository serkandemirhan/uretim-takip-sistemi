...
-- Description: Add stock reservations for jobs with planned usage dates
-- Author: Claude Code
-- Date: 2025-10-25
...
-- Each job material line gets a reservation with planned usage date
...
-- =====================================================
-- 3. FUNCTION TO AUTO-UPDATE RESERVED QUANTITY
-- =====================================================
-- This function recalculates the reserved_quantity for a stock
...
-- =====================================================
-- 4. FUNCTION TO AUTO-UPDATE USED QUANTITY IN RESERVATION
-- =====================================================
-- When warehouse makes a withdrawal linked to a reservation, update used_quantity
...
-- =====================================================
-- 5. UPDATE PURCHASE_REQUESTS TABLE
-- =====================================================
